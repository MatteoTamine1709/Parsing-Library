...
TestSuite(find_pattern_general_num_without_keep_suite);

Test(find_pattern_general_num_without_keep_suite, no_str)
{
    Parser p;
    int error = -1;
    const string str = "";
...
Test(find_pattern_general_num_without_keep_suite, no_pattern)
{
    Parser p;
    int error = -1;
    const string str = "42";
...
Test(find_pattern_general_num_without_keep_suite, no_input)
{
    Parser p;
    int error = -1;
    const string str = "";
...
Test(find_pattern_general_num_without_keep_suite, no_pattern_in_str)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_general_num_without_keep_suite, only_split_pattern)
{
    Parser p;
    int error = -1;
    const string str = "iubkbkj";
