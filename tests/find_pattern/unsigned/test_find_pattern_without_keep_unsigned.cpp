...
TestSuite(find_pattern_unsigned_without_keep_suite);

Test(find_pattern_unsigned_without_keep_suite, simple_u)
{
    Parser p;
    int error = -1;
    const string str = "42";
...
Test(find_pattern_unsigned_without_keep_suite, multiple_u)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_unsigned_without_keep_suite, simple_u_multiple_pattern)
{
    Parser p;
    int error = -1;
    const string str = "42 52";
...
Test(find_pattern_unsigned_without_keep_suite, multiple_u_multiple_pattern)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_unsigned_without_keep_suite, simple_neg_u)
{
    Parser p;
    int error = -1;
    const string str = "-54";
...
Test(find_pattern_unsigned_without_keep_suite, too_big_u)
{
    Parser p;
    int error = -1;
