...
TestSuite(find_pattern_float_keep_suite);

Test(find_pattern_float_keep_suite, simple_f)
{
    Parser p;
    int error = -1;
    const string str = "42";
...
Test(find_pattern_float_keep_suite, single_complex_f)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_float_keep_suite, multiple_f)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_float_keep_suite, multiple_complex_f)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_float_keep_suite, simple_f_multiple_pattern)
{
    Parser p;
    int error = -1;
    const string str = "42 52";
...
Test(find_pattern_float_keep_suite, complex_f_multiple_pattern)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_float_keep_suite, multiple_f_multiple_pattern)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_float_keep_suite, multiple_complex_f_multiple_pattern)
{
    Parser p;
    int error = -1;
