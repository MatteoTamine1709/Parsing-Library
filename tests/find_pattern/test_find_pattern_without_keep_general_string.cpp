...
TestSuite(find_pattern_general_string_without_keep_suite);

Test(find_pattern_general_string_without_keep_suite, no_str)
{
    Parser p;
    int error = -1;
    const string str = "";
...
Test(find_pattern_general_string_without_keep_suite, no_pattern_in_str)
{
    Parser p;
    int error = -1;
    const string str = "::::";
