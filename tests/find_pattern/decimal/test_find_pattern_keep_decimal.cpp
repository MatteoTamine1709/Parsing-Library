...
TestSuite(find_pattern_decimal_keep_suite);

Test(find_pattern_decimal_keep_suite, simple_d)
{
    Parser p;
    int error = -1;
    const string str = "42";
...
Test(find_pattern_decimal_keep_suite, multiple_d)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_decimal_keep_suite, simple_d_multiple_pattern)
{
    Parser p;
    int error = -1;
    const string str = "42 52";
...
Test(find_pattern_decimal_keep_suite, multiple_d_multiple_pattern)
{
    Parser p;
    int error = -1;
...
Test(find_pattern_decimal_keep_suite, simple_neg_d)
{
    Parser p;
    int error = -1;
    const string str = "-54";
    const string pattern = "%d";
    vector<vector<pType_v>> ret = p.find_pattern(str, pattern, true);
    vector<vector<pType_v>> correct = {{-54}};
...
Test(find_pattern_decimal_keep_suite, too_big_d)
{
    Parser p;
    int error = -1;
    const string str = "429496729500000";
    const string pattern = "%d";
    vector<vector<pType_v>> ret = p.find_pattern(str, pattern, true);
